...
from swagger_server.models.dashboard_client import DashboardClient  # noqa: F401,E501
...
class Service(Model):
    ...
    """
    def __init__(self, name: str=None, id: str=None, description: str=None, tags: List[str]=None, requires: List[str]=None, bindable: bool=None, metadata: Metadata=None, dashboard_client: DashboardClient=None, binding_rotatable: bool=None, plan_updateable: bool=None, plans: List[Plan]=None):  # noqa: E501
