...
from swagger_server.models.service_binding_resouce_object import ServiceBindingResouceObject  # noqa: F401,E501
...
class ServiceBindingRequest(Model):
    ...
    """
    def __init__(self, context: Context=None, service_id: str=None, plan_id: str=None, app_guid: str=None, bind_resource: ServiceBindingResouceObject=None, parameters: Object=None, predecessor_binding_id: str=None):  # noqa: E501
        ...
        :type bind_resource: ServiceBindingResouceObject
    ...
    @property
    def bind_resource(self) -> ServiceBindingResouceObject:
    ...
    def bind_resource(self, bind_resource: ServiceBindingResouceObject):
