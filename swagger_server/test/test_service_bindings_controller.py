...
class TestServiceBindingsController(BaseTestCase):
    ...
    def test_service_binding_binding(self):
        ...
        response = self.client.open(
            '/v2/service_instances/{instance_id}/service_bindings/{binding_id}'.format(instance_id='instance_id_example', binding_id='binding_id_example'),
            method='PUT',
    ...
    def test_service_binding_last_operation_get(self):
        ...
        headers = [('x_broker_api_version', '2.13')]
        response = self.client.open(
            '/v2/service_instances/{instance_id}/service_bindings/{binding_id}/last_operation'.format(instance_id='instance_id_example', binding_id='binding_id_example'),
            method='GET',
            headers=headers,
            query_string=query_string)
        self.assert200(response,
